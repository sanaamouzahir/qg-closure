#!/bin/bash
# submit_build_fixD_v2_K1000.sh -- build dealiased K=1000 training dataset.
#
...
#
# Usage:
#   ./submit_build_fixD_v2_K1000.sh                # SGE GPU submission
#   ./submit_build_fixD_v2_K1000.sh --interactive  # local
#   ./submit_build_fixD_v2_K1000.sh --dry-run
...
# (Note: previously this script pointed at the float32 sweep at dt_1em5;
# corrected to the float64 sweep at dt_2em5 for consistency with K=100.)
...
EXPECTED_SUBDIR="$OUT_DIR/decaying_turbulence_dT_1em2"
TARGET_SUBDIR="$OUT_DIR/decaying_turbulence_dT_1em2_fixD_v2_float64_dealiased"
...
echo "==================================================================="
echo " Build Fix D K=1000 dealiased float64 training dataset            "
echo "==================================================================="
