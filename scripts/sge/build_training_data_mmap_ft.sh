...
OUT_DIR=$SCRIPT_DIR/data/ensemble_N5            # per-member subdir appended below
...
submit_or_run() {  # $1=member
    ...
    local packed="$out_member/${SCENARIO}_dT_1em3/packed/inputs.npy"
    ...
    echo "     yaml  : $yaml"
    echo "     out   : $out_member/${SCENARIO}_dT_1em3/packed/"
