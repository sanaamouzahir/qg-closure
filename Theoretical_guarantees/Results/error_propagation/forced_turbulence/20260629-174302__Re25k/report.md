# error_propagation -- forced_turbulence -- Re25k

*20260629-174302*  |  host `ibgpu-compute-0-0.local`  |  git `unknown`  |  rc 0  |  44.0s

## Command
```
python closure_error_propagation.py ../data/ensemble_N5/FRC-Re25k/forced_turbulence_dT_5em3 --scheme ab2cn2 --orders 3 4 --n-samples 32 --device cuda
```
...
member = forced_turbulence_dT_5em3   scheme=ab2cn2  orders=[3, 4]
  grid 512x512  L=12.57  nu=4e-05 mu=0.02 beta=1  Delta_T=0.005  (avg over 32 samples)
  eps: N_dot=0.026  N_ddot=0.030  N_3dot=0.040

  ||delta|| (full assembled closure) = 4.0706e-05

  order           term  L^pow  |coef|  ||weighted term||    eps  err contrib  /||delta||
  --------------------------------------------------------------------------------------
      3      L^1 N_dot      1       1         2.0400e-07  0.026   5.3041e-09       0.01%
      3     L^0 N_ddot      0       5         4.0716e-05  0.030   1.2215e-06       3.00%
      4      L^2 N_dot      2       2         4.4604e-10  0.026   1.1597e-11       0.00%
      4     L^1 N_ddot      1       4         2.4747e-08  0.030   7.4240e-10       0.00%
      4     L^0 N_3dot      0       1         3.5483e-07  0.040   1.4193e-08       0.03%
  --------------------------------------------------------------------------------------
  closure error / ||delta||:
  ...
  explicit error fields (||.||/||delta||):
     ...
     dR4 = (dT^4/24) [ +2 L^2(0.026*N_dot) -4 L^1(0.030*N_ddot) +1 L^0(0.040*N_3dot) ]   ->  0.03%
```
