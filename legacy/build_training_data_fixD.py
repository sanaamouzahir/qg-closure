...
def build_one_seed(
    ...
    Ndot_phys      = compute_n_dot_analytical (omega_n0, derivative, L_hat, F_phys)
    Nddot_phys     = compute_n_ddot_analytical(omega_n0, derivative, L_hat, F_phys)
    ...
    # NEW: analytical input scaffolding (the operators the closure formula needs)
    # These are all evaluated at omega^0 (and time-derivative chain-ruled).
    ...
    return dict(
        ...
        # New analytical input fields (Fix D scaffolding)
        N_0              = cpu32(N_n0_phys),
        ...
        f_NN_target_from_e = cpu32(f_NN_target_from_e),
    )
...
PER_SAMPLE_FIELDS = [
    # Core inputs / outputs (unchanged from old)
    'omega_0', 'psi_0', 'grad_psi_sq', 'omega_x', 'omega_y',
    'omega_m1', 'omega_1_coarse', 'omega_K_fine',
    ...
    'L_N', 'L2_N',
    # Diagnostic: numerical f_NN target derived from -e_NN_increment / coef
    # (should ~equal f_NN_target up to higher-order Taylor truncation)
    'f_NN_target_from_e',
]
    ...
    for b_pos, b in enumerate(batches):
        ...
        for j, s_idx in enumerate(seed_indices):
            ...
            np.savez_compressed(
                ...
                f_anal=rec['f_anal'],
                # NEW (Fix D): analytical input scaffolding
                N_0=rec['N_0'],
