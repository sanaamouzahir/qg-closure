...
\TODO{itemize briefly: out-of-distribution time-step / horizon tests; learning
additional $N$-derivative orders only where the audit warrants; extension to
$\beta$ as an explicit feature for cross-regime transfer; obstacle flows.}
