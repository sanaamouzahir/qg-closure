#!/bin/bash
# train_deriv_job.sh - SGE worker for train_deriv.py (free-time-fd branch worktree)
#$ -o /gdata/projects/ml_scope/Closure_modeling/QG-closure/qg-free-time-fd/logs/$JOB_NAME.$JOB_ID.log
set -e
...
SCRIPT_DIR="$QG_ROOT/qg-free-time-fd/training"
cd "$SCRIPT_DIR"
