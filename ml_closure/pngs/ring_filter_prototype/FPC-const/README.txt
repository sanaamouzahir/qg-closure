FPC-const (cylinder) -- ring-filter prototype figures
...
Band detected automatically: columns 245..286 (width 42 px = 1.641 D),
x-station 13.057 (obstacle x_c = 12.566), artefact/background column-RMS
amplitude ratio 236.4x in the quiescent band. In-band adjacent-row
correlation (quiescent rows): -1.000 -- near -1 means the artefact is a
